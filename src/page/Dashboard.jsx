  ...
  return (
    ...
    <div className="max-w-[450px] h-[1000x] m-auto pt-16 px-10 mb-10 relative group font-Poppins">
        ...
        <div className="flex flex-row pt-4 pb-2 px-2 gap-40">
            <h1 className="font-semibold text-midblue text-lg">Subject</h1>
            <h2 className="font-medium text-lightblue text-base  ">See All</h2>
        </div>

        <h1 className=" font-semibold text-midblue opacity-50 text-lg px-2">High School - Grade 12</h1>
