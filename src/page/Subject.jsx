    ...
    <div className="max-w-[450px] h-[1000x] m-auto pt-16 px-10 mb-10 relative group font-Poppins">
        ...
        <div className="flex flex-row gap-4 mx-auto pt-8">
            <div className="w-1/4">
                ...
                <img src="/images/physics-1.svg" className="mx-auto py-4 mt-4" />
                </div>
            ...
            <div className="w-1/4">
                ...
                <img src="/images/science.svg" className="mx-auto py-4 mt-4" /> 
                </div>
            ...
            <div className="w-1/4">
                ...
                <img src="/images/chem.svg" className="mx-auto py-4 mt-4" /> 
                </div>
            ...
            <div className="w-1/4">
                ...
                <img src="/images/bio.svg" className="mx-auto py-4 mt-4" /> 
                </div>
        ...
        <div className="flex flex-row gap-4 mx-auto  pt-6">
            <div className="w-1/4">
                ...
                <img src="/images/math.svg" className="mx-auto py-4 mt-4" />
                </div>
            ...
            <div className="w-1/4">
                ...
                <img src="/images/language.svg" className="mx-auto py-4 mt-4" /> 
                </div>
            ...
            <div className="w-1/4">
                ...
                <img src="/images/lit.svg" className="mx-auto py-4 mt-4" /> 
                </div>
